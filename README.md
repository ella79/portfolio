...
`assets/cv/Emanuela-Telescu-CV.pdf` is printed from `cv.html` through the print
stylesheet at the end of `styles.css`, so the page and the PDF cannot drift
apart. To regenerate it after editing the CV, print that page to PDF at A4 with
background graphics enabled and margins of 13mm by 14mm.
